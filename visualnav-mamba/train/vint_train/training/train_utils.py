...
def evaluate_nomad(
    ...
    with torch.no_grad():
        with tqdm.tqdm(
            ...
            rand_mask_cond = ema_eval_model("vision_encoder", obs_img=batch_obs_images,
                                            goal_img=batch_goal_images, input_goal_mask=rand_goal_mask)

            obsgoal_cond = ema_eval_model("vision_encoder", obs_img=batch_obs_images,
